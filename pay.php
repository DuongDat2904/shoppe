                    ...
                    <div class="pay_oder">
                        ...
                        <div class="pay_product">
                            <div class="pay_product-main">
                                ...
                                <div class="Nivkv-">
                                    <div class="ULZMSb">
                                        <div class="z10ZuQ">Tổng số tiền (<?php echo $sl ?> sản phẩm):</div>
                                        <div class="_9F3E9v"><?php
                                                                $phi = 32700;
                                                                $tong = $sl * $row['gia_sale'] + $phi;
                                                                echo currency_format($tong)
                                                                ?></div>
                                    </div>
                                </div>
                        ...
                        <div class="DS2ZYY">
                            ...
                            <div class="KQyCj0">
                                ...
                                <div class="Tc17Ac mCEcIy BcITa9"><?php $tong = $sl * $row['gia_sale'];
                                                                    echo currency_format($tong)  ?></div>
                                <div class="Tc17Ac XIEGGF RY9Grr">Phí vận chuyển</div>
                                <div class="Tc17Ac mCEcIy RY9Grr">₫32.700</div>
