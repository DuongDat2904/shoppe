...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <style>
        input.wyhvVD._1EApiB.hq6WM5.L-VL8Q.KgaLSo.cepDQ1._7w24N1 {
            color: white;
            top: 0;
            width: 100%;
            font-size: 16px;
        ...
        .yup5K8 input[type="text"],
        .yup5K8 input[type="password"] {
    ...
    <div id="main">
        ...
        <div>
            ...
            <div class="vtexOX">
                <nav class="axexMF">
                    <div class="D3jUo5">
                        <div class="_0L93MD"><a class="UbNlH7" href="http://localhost/Shopee/login.php"><svg style="width:180px;height:180px;color:#ee4d2d" viewBox="0 0 192 65" class="shopee-svg-icon LybVoA m2rqmO icon-shopee-logo">
                                    <g fill-rule="evenodd">
                ...
                <div style="background-color: rgb(238, 77, 45);">
                    <div class="_3M9lzn PeA8Gc" style="background-image: url(&quot;https://cf.shopee.vn/file/5569eb9dc7e09e2dbed5315b8f2ea8ba&quot;); background-size: contain; background-repeat: no-repeat; background-position: center center;">
                        <div class="zfewkl">
                            <div class="LuEpZX"></div>
                            <form method="POST" action="">
                                <div class="YJ0kaz J1i6cp B-fiUo">
                                    <div class="gZNAGg">
                                        <div class="KG+Utm">
                                            <div class="K1dDgL kqkos">Đăng ký</div>
                                        </div>
                                    </div>
                                    <div class="yXry6s">
                                        <div></div>
                                        <div class="qvdx4B">
                                            <div class="yup5K8"><input class="pDzPRp" type="text" placeholder="Tên đăng nhập" autocomplete="tel" name="user" value=""></div>
                                            <div class="pYVjxt"></div>
                                            <div class="yup5K8"><input class="pDzPRp" type="password" placeholder="Mật khấu" autocomplete="tel" name="password" value=""></div>
                                        </div><input type="submit" value="Đăng kí" name="dangki" class="wyhvVD _1EApiB hq6WM5 L-VL8Q KgaLSo cepDQ1 _7w24N1"></input>
                                        <div class="x3TVMM">
                                            <div class="lhhucE">
                                                <div class="lreZhl"></div><span class="PqS8vj">hoặc</span>
                                                <div class="lreZhl"></div>
                                            </div>
                                            <div class="_3051nA"><button class="bx8TqH lyJbNT bQ2eCN">
                                                    <div class="Bq4Bra">
                                                        <div class="_1a550J social-white-background social-white-fb-blue-png"></div>
                                                    </div>
                                                    <div class="" onclick="launch_toast()">Facebook</div>
                                                </button><button class="bx8TqH lyJbNT bQ2eCN">
                                                    <div class="Bq4Bra">
                                                        <div class="_1a550J social-white-background social-white-google-png"></div>
                                                    </div>
                                                    <div class="" onclick="launch_toast()">Google</div>
                                                </button></div>
                                        </div>
                                        <div class="btS4Qu">
                                            <div class="XZg02F">Bằng việc đăng kí, bạn đã đồng ý với Shopee về <a href="https://help.shopee.vn/portal/article/77243" class="TVFtd9" target="_blank" rel="noopener noreferrer">Điều khoản dịch vụ</a> &amp; <a href="https://help.shopee.vn/portal/article/77244" class="TVFtd9" target="_blank" rel="noopener noreferrer">Chính sách bảo mật</a></div>
                                        </div>
                                    </div>
                                    <div class="XLzpXt">
                                        <div class="Oug9xv Z8OMtU">Bạn đã có tài khoản? <a class="wzgwUg" href="./login.php">Đăng nhập</a></div>
                                    </div>
                                </div>
                            </form>
                            <?php
                            ...
                            if (isset($_POST['dangki'])) {
                                $user = $_POST['user'];
                                $pass = $_POST['password'];
                                $ktra = "select * from user where username='" . $user . "'";
