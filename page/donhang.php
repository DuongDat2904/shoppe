...
<div class="bill">
    <div class="bill-main">
        ...
        <div class="bill-content">
                                ...
                                <ul class="bill_ooXtc">
                                    ...
                                    <li class="bill_qazxr">
                                        <ul class="bill_oXyt">
                                            ...
                                            <li class="bill_TxYor bill_oaiza">
                                                <?php if ($row['trangthai'] == "Đơn hàng đã được đặt" or $row['trangthai'] == "Chờ thanh toán" or $row['trangthai'] == "Đơn hàng đang giao đến bạn") {
                                                ?>
                                                    <span>Đang Giao</span>
                                                <?php } else if ($row['trangthai'] == "Hoàn thành") {
                                                ?>
                                                    <span>Đã giao</span>
                                                <?php } else if ($row['trangthai'] == "Đã hủy") { ?>
                                                    <span>Hoàn tiền</span>
                                                <?php } else if ($row['trangthai'] == "Chờ đánh giá") { ?>
                                ...
                                <ul class="bill__alpaoz">
                                    ...
                                    <li class="bill__alpozoai">
                                        <ul class="bill__paozia">
                                            ...
                                            <?php } else if ($row['trangthai'] == "Chờ đánh giá") { ?>
                                                <li class="bill__atzrqz bill_Xnaizu"><button>Đánh giá</button></li>
                                            <?php }  ?>
            ...
            <div class="tab-pane">
                <?php
                $result = mysqli_query($conn, "select * FROM `oder` INNER JOIN product on oder.ma_sanpham=product.ma_sanpham INNER JOIN product_main ON product.ma_sanpham=product_main.ma_sanpham WHERE username='$user' and trangthai='Chờ thanh toán'");
                while ($row = mysqli_fetch_array($result)) {
                ?>
                    <div class="bill-list">
                        <ul class="bill_MoXk">
            ...
            <div class="tab-pane">
                <?php
                $result = mysqli_query($conn, "select * FROM `oder` INNER JOIN product on oder.ma_sanpham=product.ma_sanpham INNER JOIN product_main ON product.ma_sanpham=product_main.ma_sanpham WHERE username='$user' and trangthai like 'Đơn hàng đã đến %'");
                while ($row = mysqli_fetch_array($result)) {
                ?>
                    <div class="bill-list">
                        <ul class="bill_MoXk">
            ...
            <div class="tab-pane">
                <?php
                $result = mysqli_query($conn, "select * FROM `oder` INNER JOIN product on oder.ma_sanpham=product.ma_sanpham INNER JOIN product_main ON product.ma_sanpham=product_main.ma_sanpham WHERE username='$user' and trangthai='Đơn hàng đang giao đến bạn'");
                while ($row = mysqli_fetch_array($result)) {
                ?>
                    <div class="bill-list">
                        <ul class="bill_MoXk">
            ...
            <div class="tab-pane">
                <?php
                $result = mysqli_query($conn, "select * FROM `oder` INNER JOIN product on oder.ma_sanpham=product.ma_sanpham INNER JOIN product_main ON product.ma_sanpham=product_main.ma_sanpham WHERE username='$user' and trangthai='Hoàn thành'");
                while ($row = mysqli_fetch_array($result)) {
                ?>
                    <div class="bill-list">
                        <ul class="bill_MoXk">
            ...
            <div class="tab-pane"> <?php
                                    $result = mysqli_query($conn, "select * FROM `oder` INNER JOIN product on oder.ma_sanpham=product.ma_sanpham INNER JOIN product_main ON product.ma_sanpham=product_main.ma_sanpham WHERE username='$user' and trangthai='Đã hủy'");
                                    while ($row = mysqli_fetch_array($result)) {
                                    ?>
                    <div class="bill-list">
                        <ul class="bill_MoXk">
            ...
            <div class="tab-pane"> <?php
                                    $result = mysqli_query($conn, "select * FROM `oder` INNER JOIN product on oder.ma_sanpham=product.ma_sanpham INNER JOIN product_main ON product.ma_sanpham=product_main.ma_sanpham WHERE username='$user' and trangthai='Chờ đánh giá'");
                                    while ($row = mysqli_fetch_array($result)) {
                                    ?>
                    <div class="bill-list">
                        <ul class="bill_MoXk">
